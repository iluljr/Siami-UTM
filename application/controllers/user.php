...
class user extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['jumlah_data_MA'] = $this->model_user->datatable_2a_MA();
		$data['jumlah_dosen'] = $this->model_user->datatable_2a_Dosen();
		$data['jumlah_data_MB'] = $this->model_user->datatable_2a_MB();
		$data['table8a_rata']=$this->model_user->table8a_rata();

		$data['tahunsekarang_2b']=$this->model_user->tahunsekarang_2b($data['id_tahun']);
		...
		//table_8b
		$data['view_table8b_jumlah_NI'] = $this->model_user->gettable8b_jumlah_NI();
		$data['view_table8b_jumlah_NN'] = $this->model_user->gettable8b_jumlah_NN();
		$data['view_table8b_jumlah_NW'] = $this->model_user->gettable8b_jumlah_NW();
		//table_8c
		$data['view_table8c_jml'] = $this->model_user->gettable8c_jml_rata();
		$data['view_table8c_jml_ts3'] = $this->model_user->gettable8c_jml_ts3();
		$data['view_table8c_jml_ts3_ts6'] = $this->model_user->gettable8c_jml_ts3_ts6();
		//table_8d1
		$data['jumlah_data_8d1'] = $this->model_user->datatable_8d1();
		//table_8d2
		$data['jumlah_data_8d2'] = $this->model_user->datatable_8d2();
		//table_8e1
		$data['jumlah_data_8e'] = $this->model_user->datatable_8e1();

		$data['view_table2a_jumlahmhs'] = $this->model_user->gettable2b_jumlahmhs();
		...
		$this->load->view("user/layout/footer_admin");
	}
	...
	public function table_2a()
	{
		...
		$data['jumlah_data_MA'] = $this->model_user->datatable_2a_MA($data['id_tahun'],$data['id_prodi']);
		$data['jumlah_dosen'] = $this->model_user->datatable_2a_Dosen($data['id_tahun'],$data['id_prodi']);
		$data['jumlah_data_MB'] = $this->model_user->datatable_2a_MB($data['id_tahun'],$data['id_prodi']);
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/134table_2a",$data);
		$this->load->view("user/layout/footer_admin");
	...
	public function edit_tabel2a($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel2a', $data);
		$this->load->view("user/layout/footer_admin");
	}
	public function edit_tabel2a_dosen($id)
	{
		...
		$this->model_user->update_data($where,$data,'dosen');
		redirect('user/table_2a');
	}
	public function update_tabel2a()
	{
		...
		$where = array('id_tabel2a' => $id);
		$this->model_user->update_data($where,$data,'tabel_2a');
		redirect('user/table_2a');
	}
	public function hapus_tabel2a($id)
	{
		$where = array('id_tabel2a' => $id);
		$this->model_user->hapus_data($where,'tabel_2a');
	...
	public function table_2b()
	{
		...
		$data['prodi']=$this->model_log->prodi($data['id_akses']);
		$data['fakultas']=$this->model_log->fakultas($data['id_akses']);
		$data['view_table2a'] = $this->model_user->gettable2b($data['id_tahun']);
		$data['view_table2a_min1'] = $this->model_user->gettable2b_min1($data['id_tahun']);
		$data['view_table2a_min2'] = $this->model_user->gettable2b_min2($data['id_tahun']);
		$data['tahunsekarang_2b']=$this->model_user->tahunsekarang_2b($data['id_tahun']);
		$data['view_table2a_jumlahmhs'] = $this->model_user->gettable2b_jumlahmhs($data['id_tahun']);
		$data['judul'] = 'Table 2.b';

		$this->load->view("user/layout/header_admin");
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/2table_2b",$data);
		$this->load->view("user/layout/footer_admin");
	...
	public function edit_tabel2b($tahun)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel2b', $data);
		$this->load->view("user/layout/footer_admin");
	}
	...
	public function table_8a()
	{
		...
		$data['view_table8a'] = $this->model_user->gettable8a($data['id_tahun'],$data['id_prodi']);
		$data['tahunsekarang_2b']=$this->model_user->tahunsekarang_2b($data['id_tahun']);
		$data['table8a_rata']=$this->model_user->table8a_rata($data['id_tahun'],$data['id_prodi']);
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/5table_8a",$data);
		$this->load->view("user/layout/footer_admin");
	...
	public function hapus_tabel8a($id)
	{
		...
		$this->model_user->hapus_data($where,'tabel_8a');
		redirect('user/table_8a');
	}
	...
	public function edit_tabel8a($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel8a', $data);
		$this->load->view("user/layout/footer_admin");
	}
	public function update_tabel8a()
	{
		...
		$where = array('id_tabel8a' => $id);
		$this->model_user->update_data($where,$data,'tabel_8a');
		redirect('user/table_8a');
	}
	...
	public function table_8b()
	{
		...
		$data['view_table8b'] = $this->model_user->gettable8b($data['id_tahun'],$data['id_prodi']);
		$data['tahunsekarang_2b']=$this->model_user->tahunsekarang_2b($data['id_tahun']);
		$data['view_table8b_jumlah_NI'] = $this->model_user->gettable8b_jumlah_NI($data['id_tahun'],$data['id_prodi']);
		$data['view_table8b_jumlah_NN'] = $this->model_user->gettable8b_jumlah_NN($data['id_tahun'],$data['id_prodi']);
		$data['view_table8b_jumlah_NW'] = $this->model_user->gettable8b_jumlah_NW($data['id_tahun'],$data['id_prodi']);
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/5table_8b",$data);
		$this->load->view("user/layout/footer_admin");
	}
	...
	public function edit_tabel8b($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel8b', $data);
		$this->load->view("user/layout/footer_admin");
	}
	public function update_tabel8b()
	{
		...
		$where = array('id_tabel8b' => $id);
		$this->model_user->update_data($where,$data,'tabel_8b');
		redirect('user/table_8b');
	}
	...
	public function table_8c()
	{
		...
		$data['view_table8c'] = $this->model_user->gettable8c($data['id_tahun'],$data['id_prodi']);
		$data['view_table8c_jml'] = $this->model_user->gettable8c_jml_rata($data['id_tahun'],$data['id_prodi']);
		$data['view_table8c_jml_ts3'] = $this->model_user->gettable8c_jml_ts3($data['id_tahun'],$data['id_prodi']);
		$data['view_table8c_jml_ts3_ts6'] = $this->model_user->gettable8c_jml_ts3_ts6($data['id_tahun'],$data['id_prodi']);
		$data['tahun_ms'] = $this->model_user->tahun_ms($data['id_tahun'],$data['id_prodi']);
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/7table_8c",$data);
		$this->load->view("user/layout/footer_admin");
	}
	...
	public function edit_tabel8c($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel8c', $data);
		$this->load->view("user/layout/footer_admin");
	}
	...
	public function update_tabel8c()
	{
		...
		$where = array('id_tabel8c' => $id);
		$this->model_user->update_data($where,$data,'tabel_8c');
		redirect('user/table_8c');
	}
	...
	{
		$where = array('id_tabel8c' => $id);
		$this->model_user->hapus_data($where,'tabel_8c');
		redirect('user/table_8c');
	}
	...
	public function table_8d1()
	{
		...
		$data['view_table8d1'] = $this->model_user->gettable8d1($data['id_tahun'],$data['id_prodi']);
		$data['jumlah_data'] = $this->model_user->datatable_8d1($data['id_tahun'],$data['id_prodi']);
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/10table_8d1",$data);
		$this->load->view("user/layout/footer_admin");
	...
	public function hapus_table8d1($id)
	{
		...
		$this->model_user->hapus_data($where,'table_8d1');
		redirect('user/table_8d1');
	}
	...
	public function edit_table8d1($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel8d1', $data);
		$this->load->view("user/layout/footer_admin");
	}
	public function update_table8d1()
	{
		...
		$where = array('id_table8d1' => $id);
		$this->model_user->update_data($where,$data,'table_8d1');
		redirect('user/table_8d1');
	}
	...
	public function table_8d2()
	{
		...
		$data['view_table8d2'] = $this->model_user->gettable8d2($data['id_tahun'],$data['id_prodi']);
		$data['jumlah_data'] = $this->model_user->datatable_8d2($data['id_tahun'],$data['id_prodi']);
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/11table_8d2",$data);
		$this->load->view("user/layout/footer_admin");
	...
	public function edit_table8d2($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel8d2', $data);
		$this->load->view("user/layout/footer_admin");
	}
	...
	public function table_8e1()
	{
		...
		$data['view_table8e1'] = $this->model_user->gettable8e1($data['id_tahun'],$data['id_prodi']);
		$data['jumlah_data'] = $this->model_user->datatable_8e1($data['id_tahun'],$data['id_prodi']);
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view("user/12table_8e1",$data);
		$this->load->view("user/layout/footer_admin");
	...
	public function edit_table8e1($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/edit_tabel8e1', $data);
		$this->load->view("user/layout/footer_admin");
	}
	...
	public function tambah_akun()
	{
	   ...
	   $password = md5($this->input->post('password'));
		 ...
		 redirect('user/user_akun');
	}

	public function hapus_akun($id)
	{
		$where = array('id_user' => $id);
		$this->model_user->hapus_data($where,'akun');
		redirect('user/user_akun');
	}
	...
	public function edit_akun($id)
	{
	  ...
	  $password = md5($this->input->post('password'));
		...
		$where = array('id_user' => $id);
		$this->model_user->update_data($where,$data,'akun');
		redirect('user/user_akun');
	}
	...
	public function levelakses($id)
	{
		...
		$this->load->view("user/layout/sidebar",$data);
		$this->load->view("user/layout/topbar_admin");
		$this->load->view('user/level-akses', $data);
		$this->load->view("user/layout/footer_admin");
	}
