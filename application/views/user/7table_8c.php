        ...
        <table class="table table-bordered" width="1600px" cellspacing="0">
          ...
          <tbody>
            ...
            <tr align="center">
              ...
              <td><?= $tb['rata_studi']?></td>
              <td><?php echo anchor('user/edit_tabel8c/'.$tb['id_tabel8c'],('<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>'));?></td>
...
<div class="modal fade" id="databaru" tabindex="-1" role="dialog" aria-labelledby="DataBaru" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url('user/tambah_data8c'); ?>" method="POST" class="needs-validation" novalidate>
