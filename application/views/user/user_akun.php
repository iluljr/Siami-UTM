    	...
    	<div class="row">
    		<div class="col-md">
    			<nav class="navbar navbar-light bg-light">
    				...
    				<form class="form-inline" action="<?= base_url('user/user_akun'); ?>" method="post">
    					...
    					<?php foreach ($users as $u) : ?>
    						<tr>
    							...
    							<td>
    								...
    								<a href="<?= base_url() . 'user/hapus_akun/' . $u['id_user'] ?>" data-nama="<?= $u['username']; ?>" class="btn btn-danger btn-sm deleteU"><i class="fa fa-fw fa-trash"></i>Delete</a>
    							</td>
    						</tr>
    					<?php endforeach; ?>
    				</tbody>
	...
	<div class="modal fade" id="Edit_akun<?= $u['id_user'] ?>" tabindex="-1" role="dialog" aria-labelledby="pelamarEditLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="<?= base_url('user/edit_akun/' . $u['id_user']); ?>" method="POST">
...
<div class="modal fade" id="userBaru" tabindex="-1" role="dialog" aria-labelledby="userBaruLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url('user/tambah_akun'); ?>" method="POST" class="needs-validation" novalidate>
				<div class="modal-body">
					<div class="form-group">
