...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form class="form-inline mb-2" action="<?= base_url('user/table_8d1'); ?>" method="post">
      <table align="center">
        <tr>
        ...
        <table class="table table-bordered" width="1600px" cellspacing="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?= $tb['wt_18']?></td>
              <td><?= $tb['wt_lebih']?></td>
              <td><?php echo anchor('user/edit_table8d1/'.$tb['id_table8d1'],('<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>'));?></td>
              <td><div onclick="javascript: return confirm('Anda yakin ingin menghapus data ini ?')"><?php echo anchor('user/hapus_table8d1/'.$tb['id_table8d1'],('<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>'));?></div>
              </td>
            </tr>
          <?php endforeach;?>
          </tbody>
...
<div class="modal fade" id="databaru" tabindex="-1" role="dialog" aria-labelledby="DataBaru" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url('user/tambah_data8d1'); ?>" method="POST" class="needs-validation" novalidate>
