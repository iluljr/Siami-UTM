...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <form class="form-inline mb-2" action="<?= base_url('user/table_2a'); ?>" method="post">
        ...
        <table class="table table-bordered" width="1600px" cellspacing="0">
          ...
          <tbody>
            ...
            <tr align="center">
              ...
              <td><?php echo anchor('user/edit_tabel2a/'.$tb['id_tabel2a'],('<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>'));?></td>
              <td><div onclick="javascript: return confirm('Anda yakin ingin menghapus data ini ?')"><?php echo anchor('user/hapus_tabel2a/'.$tb['id_tabel2a'],('<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>'));?></div>
              </td>
            </tr>
          <?php endforeach;?>
          </tbody>
...
<div class="modal fade" id="databaru" tabindex="-1" role="dialog" aria-labelledby="DataBaru" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url('user/tambah_data2a'); ?>" method="POST" class="needs-validation" novalidate>
...
<div class="modal fade" id="dosenEdit<?= $jdosen['id_dosen'] ?>" tabindex="-1" role="dialog" aria-labelledby="pelamarEditLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?= base_url('user/edit_tabel2a_dosen/' . $jdosen['id_dosen']); ?>" method="POST">
        <div class="modal-body">
          <div class="form-group">
